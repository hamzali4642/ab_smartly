...
void main() {
  group("context", () {
    ...
    setUp(() async {
      ...
      dataFuture.complete(dataFutureReady);
      dataFuture.completeError(dataFutureFailed);
  ...
  //   });
  //
  //   test("testStartsRefreshTimerWhenReady", () {
  ...
  //
    test("setUnits", () async {
      ...
      units.forEach((key, value) {
        print(key);
        print(context.getUnit("key"));
        expect(value, context.getUnit("key"));
      });
      expect(units, context.getUnits());
    });
  //
